...
class Turf {
  ...
  factory Turf.fromJson(Map<String, dynamic> json) {
    ...
    return Turf(
      ...
      isOnlinePaymentActive: json['is_online_payment_active'] == true || json['is_online_payment_active'] == 1 || json['is_online_payment_active'] == '1',
      isPartPaymentActive: json['is_part_payment_active'] == true || json['is_part_payment_active'] == 1 || json['is_part_payment_active'] == '1',
      isPayAtLocationActive: json['is_pay_at_location_active'] == null ? true : (json['is_pay_at_location_active'] == true || json['is_pay_at_location_active'] == 1 || json['is_pay_at_location_active'] == '1'),
